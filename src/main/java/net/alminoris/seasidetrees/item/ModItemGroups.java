package net.alminoris.seasidetrees.item;
...
{
    public static final ItemGroup SEASIDE_TREES_TAB = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "seasidetreestab"),
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.seasidetreestab"))
