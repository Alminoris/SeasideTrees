package net.alminoris.seasidetrees.block;
...
public class ModBlocks 
{
    private static Block registerBlock(String name, Block block)
    {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block)
    {
        Registry.register(Registries.ITEM, Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, name),
    ...
    public static Block registerSignBlock(String name)
    {
        return registerBlock(name+"_sign",
                new TerraformSignBlock(Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "entity/signs/"+name), AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    }

    public static Block registerWallSignBlock(String name)
    {
        return registerBlock(name+"_wall_sign",
                new TerraformWallSignBlock(Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "entity/signs/"+name), AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    }

    public static Block registerHangingSignBlock(String name)
    {
        return registerBlock(name+"_hanging_sign",
                new TerraformHangingSignBlock(Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "entity/signs/hanging/"+name),
                        Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "textures/gui/hanging_signs/"+name), AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    }

    public static Block registerWallHangingSignBlock(String name)
    {
        return registerBlock(name+"_wall_hanging_sign",
                new TerraformWallHangingSignBlock(Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "entity/signs/hanging/"+name),
                        Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, "textures/gui/hanging_signs/"+name), AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
    }
