package net.alminoris.seasidetrees.util.helper;

import net.alminoris.seasidetrees.entity.ModBoats;
import net.alminoris.seasidetrees.world.tree.ModSaplingGenerators;
...
import static net.alminoris.seasidetrees.block.ModBlocks.*;
import static net.alminoris.seasidetrees.item.ModItems.*;

public class ModBlockSetsHelper
{
    //"platanus", "pink_lapacho"
    public static final String[] WOOD_NAMES = new String[] { "sea grape", "buttonwood", "wax myrtle", "live oak" };
