package net.alminoris.seasidetrees.world;
...
public class ModPlacedFeatures
{
    ...
    {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(net.alminoris.seasidetrees.SeasideTrees.MOD_ID, name));
    }
